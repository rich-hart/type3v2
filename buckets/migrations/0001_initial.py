...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('fsobject_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='buckets.FSObject')),
                ('format', models.CharField(choices=[(0, buckets.models.File.Format['undefined'])], default=None, max_length=3, null=True)),
                ('_path', models.FileField(storage=project.storage_backends.StaticStorage(), upload_to='')),
                ('_instance', models.FileField(storage=project.storage_backends.StaticStorage(), upload_to='')),
            ],
            options={
                'abstract': False,
            },
